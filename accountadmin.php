...
function DisplayPage()
{
	...
	else
	{
		...
		?>	<br>
			...
			<a href="unsubscribe.php" onclick="return confirm('Are you sure?  This will not only cancel your subscription but delete all of your golf courses and scores.')">Cancel Subscription and Account</a><br><?
		//printf("</div>");
	}
	DisplayCommonFooter();
}
